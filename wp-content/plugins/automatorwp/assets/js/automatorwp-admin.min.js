...
var automation_id=$('input#object_id').val();var automation_type=$('select#type').val();var items_per_loop=0;if(automation_type==='all-users'){items_per_loop=$('input#users_per_loop').val()}else if(automation_type==='all-posts'){items_per_loop=$('input#posts_per_loop').val()}else if(automation_type==='import-file'){items_per_loop=$('input#lines_per_loop').val()}
