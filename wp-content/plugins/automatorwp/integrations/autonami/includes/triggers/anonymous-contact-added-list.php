<?php
/**
 * Anonymous Contact Added List
 *
 * @package     AutomatorWP\Integrations\Autonami\Triggers\Anonymous_Contact_Added_List
...
class AutomatorWP_Autonami_Anonymous_Contact_Added_List extends AutomatorWP_Integration_Trigger {

    public $integration = 'autonami';
    public $trigger = 'autonami_anonymous_contact_added_list';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Contact is added to list', 'automatorwp' ),
            'select_option'     => __( 'Contact is added to <strong>list</strong>', 'automatorwp' ),
            /* translators: %1$s: List. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Contact is added to %1$s %2$s time(s)', 'automatorwp' ), '{list}', '{times}' ),
            /* translators: %1$s: List. */
            'log_label'         => sprintf( __( 'Contact is added to %1$s', 'automatorwp' ), '{list}' ),
...
new AutomatorWP_Autonami_Anonymous_Contact_Added_List();