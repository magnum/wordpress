...
class AutomatorWP_WordPress_Anonymous_Comment_Post_Type extends AutomatorWP_Integration_Trigger {
    ...
    public function __construct( $integration ) {
        ...
        $this->trigger = $integration . '_anonymous_comment_post_type';
...
new AutomatorWP_WordPress_Anonymous_Comment_Post_Type( 'wordpress' );
new AutomatorWP_WordPress_Anonymous_Comment_Post_Type( 'comments' );