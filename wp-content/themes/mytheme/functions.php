...
function myplugin_acf_work_block_render($block){
	// convert name ("acf/[something]") into path friendly slug
	$slug = str_replace('acf/', '', $block['name']);
	$template_path = STYLESHEETPATH . "/template-parts/block/content-{$slug}.php";
...
function myplugin_acf_init() { 
	...
	if( function_exists('acf_register_block') ) {
		...
		acf_register_block(array(
			...
			'render_callback'	=> 'myplugin_acf_work_block_render',
			'category'			=> 'widgets',
			'icon'				=> 'admin-comments',
			'keywords'			=> array( 'param', 'value' ),
		));
	}
}
add_action('acf/init', 'myplugin_acf_init');
